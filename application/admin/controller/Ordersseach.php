...
use think\Config;
use think\Db;
class Ordersseach extends Online
{
        ...
        if(!empty($count)){
            $list = Db::table('orders')
                ...
                ->paginate(10,$count,[
                    ...
                    'path'=>url('index').'?page=[PAGE]'."&order_status=".$status."&keyworld=".$keyworld."&order_time=".$order_time."&end_time=".$end_time."&user_id=".$merchant_id
